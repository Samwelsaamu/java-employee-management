...
public class SystemAdminWorkerFinancePanel extends javax.swing.JPanel {
    ...
    public SystemAdminWorkerFinancePanel(JPanel logincontainerJPanel,JPanel container,OrganizationDirectory directory, UserAccount user, EmployeeManagement system) {
        initComponents();
        this.system=system;
    ...
    private void enterprisessjTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_enterprisessjTableMouseClicked
        ...
        this.rolejComboBox.setSelectedItem((Role)selUser.getRole());
        organizationjComboBox.setSelectedIndex(0);
